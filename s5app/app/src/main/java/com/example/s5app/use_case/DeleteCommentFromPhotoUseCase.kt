...
class DeleteCommentFromPhotoUseCase(
    ...
    suspend operator fun invoke(userToken: String, imageId: String, commentId: String, adminToken: String): ApiResult<Unit> {
        return repository.deleteCommentFromPhoto(userToken, imageId, commentId, adminToken)
    }
}